...
class PhasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create phase" do
    assert_difference('Phase.count') do
      post phases_url, params: { phase: { name: @phase.name, summary_id: @phase.summary_id } }
    end
  ...
  test "should update phase" do
    patch phase_url(@phase), params: { phase: { name: @phase.name, summary_id: @phase.summary_id } }
