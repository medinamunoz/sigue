...
class SummariesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create summary" do
    assert_difference('Summary.count') do
      post summaries_url, params: { summary: { description: @summary.description, finishing_day: @summary.finishing_day, resolution: @summary.resolution, starting_day: @summary.starting_day } }
    end
  ...
  test "should update summary" do
    patch summary_url(@summary), params: { summary: { description: @summary.description, finishing_day: @summary.finishing_day, resolution: @summary.resolution, starting_day: @summary.starting_day } }
